    ...
    <div className="min-h-screen overflow-hidden bg-background flex flex-col items-center justify-center px-6 relative">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 w-full max-w-sm mt-2">
          <div className="flex items-center w-full rounded-2xl border border-foreground/25 bg-foreground/5 py-2 pl-7 pr-2 transition-all duration-300 shadow-[0_0_20px_-5px_hsl(var(--foreground)/0.2)] ring-1 ring-foreground/10 ring-offset-2 ring-offset-background">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 w-full px-6 py-4 rounded-2xl border border-foreground/25 shadow-[0_0_20px_-5px_hsl(var(--foreground)/0.2)] ring-1 ring-foreground/10 ring-offset-2 ring-offset-background text-foreground font-medium hover:bg-foreground/5 transition-all text-sm"
          >
            <Download size={16} />
            Save Contact
          </button>
